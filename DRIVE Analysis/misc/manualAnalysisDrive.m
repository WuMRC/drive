...
[bmax, imax, bmin, imin] = extrema(max((respLegSMOOTH(timeMarkerBioimpedanceInd(DATA_TO_ANALYZE)+Fs*offset:...
    (timeMarkerBioimpedanceInd(DATA_TO_ANALYZE)+Fs*totalTime)) ...
    - mean(respLegSMOOTH(timeMarkerBioimpedanceInd(DATA_TO_ANALYZE)+Fs*offset:...
    (timeMarkerBioimpedanceInd(DATA_TO_ANALYZE)+Fs*totalTime)))))...
    -(respLegSMOOTH(timeMarkerBioimpedanceInd(DATA_TO_ANALYZE)+Fs*offset:...
...
plot(timeBioimpedance',max((respLegSMOOTH(timeMarkerBioimpedanceInd(DATA_TO_ANALYZE)+Fs*offset:...
    (timeMarkerBioimpedanceInd(DATA_TO_ANALYZE)+Fs*totalTime)) ...
    - mean(respLegSMOOTH(timeMarkerBioimpedanceInd(DATA_TO_ANALYZE)+Fs*offset:...
    (timeMarkerBioimpedanceInd(DATA_TO_ANALYZE)+Fs*totalTime)))))...
    -(respLegSMOOTH(timeMarkerBioimpedanceInd(DATA_TO_ANALYZE)+Fs*offset:...
...
hold on, plot(timeBioimpedance(imax),bmax,'r*',timeBioimpedance(imin), bmin, 'ro')
